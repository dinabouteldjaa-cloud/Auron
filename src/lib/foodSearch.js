...
// ── French display names for the local food database, keyed by id ──
export const LOCAL_DB_NAME_FR = {
  'l1': 'Blanc de poulet, cuit (100g)',
  'l2': 'Cuisse de poulet, cuite (100g)',
  'l3': 'Filet de saumon (100g)',
  'l4': 'Thon en conserve au naturel (100g)',
  'l5': 'Bœuf haché à 20% de matière grasse (100g)',
  'l6': 'Œuf entier (1 gros)',
  'l7': 'Blancs d\'œufs (100g)',
  'l8': 'Crevettes, cuites (100g)',
  'l9': 'Blanc de dinde (100g)',
  'l10': 'Shake protéiné à la whey (1 dose)',
  'l11': 'Yaourt grec nature (150g)',
  'l12': 'Fromage cottage (100g)',
  'l13': 'Lait entier (250ml)',
  'l14': 'Lait écrémé (250ml)',
  'l15': 'Cheddar (30g)',
  'l16': 'Mozzarella (30g)',
  'l17': 'Riz complet, cuit (100g)',
  'l18': 'Riz blanc, cuit (100g)',
  'l19': 'Pâtes, cuites (100g)',
  'l20': 'Flocons d\'avoine, secs (50g)',
  'l21': 'Pain complet (1 tranche)',
  'l22': 'Quinoa, cuit (100g)',
  'l23': 'Pain pita (1 pièce)',
  'l24': 'Tortilla (1 moyenne)',
  'l25': 'Brocoli (100g)',
  'l26': 'Épinards (100g)',
  'l27': 'Patate douce (150g)',
  'l28': 'Carotte (1 moyenne)',
  'l29': 'Salade mélangée (100g)',
  'l30': 'Tomate (1 moyenne)',
  'l31': 'Concombre (100g)',
  'l32': 'Poivron (1 moyen)',
  'l33': 'Banane (1 moyenne)',
  'l34': 'Pomme (1 moyenne)',
  'l35': 'Orange (1 moyenne)',
  'l36': 'Fraises (100g)',
  'l37': 'Myrtilles (100g)',
  'l38': 'Mangue (100g)',
  'l39': 'Dattes (3 pièces)',
  ...
  'l41': 'Amandes (30g)',
  'l42': 'Noix (30g)',
  'l43': 'Beurre de cacahuète (2 c. à s.)',
  'l44': 'Huile d\'olive (1 c. à s.)',
  'l45': 'Graines de courge (30g)',
  'l46': 'Lentilles, cuites (100g)',
  'l47': 'Pois chiches, cuits (100g)',
  'l48': 'Haricots noirs, cuits (100g)',
  'l49': 'Edamame (100g)',
  'l50': 'Houmous (2 c. à s.)',
  'l51': 'Œufs brouillés (2 œufs)',
  'l52': 'Sandwich au fromage grillé',
  'l53': 'Salade César (200g)',
  'l54': 'Spaghetti bolognaise (300g)',
  'l55': 'Pizza margherita (1 part)',
  'l56': 'Cheeseburger (1 moyen)',
  'l57': 'Salade de poulet grillé',
  'l58': 'Wrap shawarma (poulet)',
  'l59': 'Falafel (3 pièces)',
  'l60': 'Taboulé (100g)',
  'l61': 'Salade fattouche (200g)',
  'l62': 'Mansaf avec riz (350g)',
  'l63': 'Labneh (2 c. à s.)',
  'l64': 'Pita au houmous (1 portion)',
  'l65': 'Kabsa au poulet (400g)',
  'l66': 'Café noir (240ml)',
  'l67': 'Café au lait (240ml)',
  'l68': 'Jus d\'orange (250ml)',
  'l69': 'Shake protéiné (prêt à boire)',
  'l70': 'Latte (grande, lait 2%)',
}

// Centralized helper — localized display name for a food item, with
// graceful English fallback. Never returns undefined.
export function getLocalizedFoodName(food, lang) {
  if (!food) return ''
  if (lang === 'fr' && food.id && LOCAL_DB_NAME_FR[food.id]) return LOCAL_DB_NAME_FR[food.id]
  return food.name || ''
}
