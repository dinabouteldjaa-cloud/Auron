...
export const EXERCISES_FR = {
  'Bench Press': { name:'Développé couché', muscles:'Pectoraux, Triceps, Épaules', howTo:['Allongé sur le banc, pieds au sol','Prise légèrement plus large que les épaules','Descendre la barre vers le milieu de la poitrine','Pousser vers le haut de manière explosive'], tips:'Ne rebondissez jamais la barre sur la poitrine.' },
  'Incline Bench Press': { name:'Développé incliné', muscles:'Pectoraux supérieurs, Épaules', howTo:['Incliner le banc à 30-45°','Descendre la barre vers le haut de la poitrine','Pousser vers le haut et légèrement en arrière'], tips:'Au-delà de 45° la charge passe sur les épaules.' },
  'Push Ups': { name:'Pompes', muscles:'Pectoraux, Triceps, Core', howTo:['Position planche, mains plus larges que les épaules','Garder le corps droit','Descendre la poitrine vers le sol','Repousser vers le haut'], tips:'Ne laissez pas les hanches s\'affaisser.' },
  'Chest Fly': { name:'Écarté couché', muscles:'Pectoraux', howTo:['Allongé avec haltères au-dessus de la poitrine','Descendre les bras en arc','Contracter pour ramener les haltères'], tips:'Concentrez-vous sur l\'étirement en bas.' },
  'Dips': { name:'Dips', muscles:'Pectoraux, Triceps', howTo:['Saisir les barres parallèles','Se pencher en avant pour cibler les pectoraux','Descendre jusqu\'à ce que les bras soient parallèles au sol','Repousser'], tips:'Penché en avant = pectoraux, droit = triceps.' },
  'Cable Crossover': { name:'Poulie vis-à-vis', muscles:'Pectoraux', howTo:['Régler les câbles en hauteur','Tirer les poignées ensemble devant la poitrine','Contracter au point de contraction maximal'], tips:'Excellent exercice de finition.' },
  'Pull Ups': { name:'Tractions', muscles:'Dorsaux, Biceps', howTo:['Se suspendre prise en pronation','Tirer les omoplates vers le bas d\'abord','Monter jusqu\'au menton au-dessus de la barre','Redescendre lentement'], tips:'L\'amplitude complète est essentielle.' },
  'Deadlift': { name:'Soulevé de terre', muscles:'Dos complet, Ischio-jambiers, Fessiers', howTo:['Barre sur le milieu du pied','Hanches fléchies, prise à l\'extérieur des jambes','Poitrine haute, gainage du core','Pousser dans le sol','Verrouiller les hanches en haut'], tips:'Ne jamais arrondir le bas du dos.' },
  'Bent Over Row': { name:'Rowing buste penché', muscles:'Dos, Biceps', howTo:['Se pencher en avant, dos plat','Tirer la barre vers le bas de la poitrine','Contracter les omoplates au sommet'], tips:'Gardez le dos plat tout au long du mouvement.' },
  'Lat Pulldown': { name:'Tirage vertical', muscles:'Dorsaux, Biceps', howTo:['Saisir la barre largement, s\'asseoir droit','Tirer vers le haut de la poitrine','Retour lent en extension complète'], tips:'Imaginez tirer les coudes vers les poches arrière.' },
  'Seated Cable Row': { name:'Rowing assis à la poulie', muscles:'Dos moyen, Biceps', howTo:['Assis droit, pieds sur la plateforme','Tirer vers l\'abdomen, coudes en arrière','Contracter les omoplates au sommet'], tips:'N\'utilisez pas l\'élan.' },
  'Face Pull': { name:'Face pull', muscles:'Deltoïdes postérieurs, Dos haut', howTo:['Câble à hauteur du visage, corde attachée','Tirer vers le visage, coudes hauts et larges','Rotation externe en fin de mouvement'], tips:'Excellent pour la santé des épaules.' },
  'Squat': { name:'Squat', muscles:'Quadriceps, Fessiers, Ischio-jambiers', howTo:['Barre sur les trapèzes, pieds écartés à la largeur des épaules','Bracing du core','Genoux vers l\'extérieur, s\'asseoir vers le bas','Cuisses parallèles au minimum','Pousser dans le sol pour se relever'], tips:'Les genoux suivent la direction des orteils.' },
  'Romanian Deadlift': { name:'Soulevé de terre roumain', muscles:'Ischio-jambiers, Fessiers', howTo:['Tenir la barre, reculer les hanches','Descendre la barre le long des jambes','Sentir l\'étirement des ischio-jambiers','Pousser les hanches vers l\'avant'], tips:'Mouvement de charnière de hanche, pas un squat.' },
  'Leg Press': { name:'Presse à cuisses', muscles:'Quadriceps, Fessiers', howTo:['Pieds écartés sur la plateforme','Descendre à 90°','Pousser sans verrouiller les genoux'], tips:'Pieds haut = fessiers, bas = quadriceps.' },
  'Lunges': { name:'Fentes', muscles:'Quadriceps, Fessiers', howTo:['Faire un grand pas en avant','Abaisser le genou arrière vers le sol','Genou avant au-dessus de la cheville','Repousser vers le haut'], tips:'Foulée longue = fessiers, courte = quadriceps.' },
  'Hip Thrust': { name:'Hip thrust', muscles:'Fessiers, Ischio-jambiers', howTo:['Dos sur le banc, barre sur les hanches','Pousser les hanches vers le haut','Contracter les fessiers au sommet'], tips:'Le meilleur exercice pour les fessiers.' },
  'Calf Raises': { name:'Mollets debout', muscles:'Mollets', howTo:['Se lever sur les pointes des pieds','Tenir la contraction 1 seconde','Descendre sous le niveau de la marche'], tips:'Amplitude complète, répétitions élevées.' },
  'Overhead Press': { name:'Développé militaire', muscles:'Épaules, Triceps', howTo:['Barre à hauteur des épaules','Presser droit vers le haut','Verrouiller en haut'], tips:'Gainé tout au long du mouvement.' },
  'Lateral Raise': { name:'Élévations latérales', muscles:'Deltoïdes latéraux', howTo:['Lever les bras sur les côtés','Parallèle au sol','L\'auriculaire légèrement plus haut'], tips:'Moins de poids qu\'on ne le croit.' },
  'Arnold Press': { name:'Développé Arnold', muscles:'Tous les chefs du deltoïde', howTo:['Paumes face à soi à hauteur des épaules','Presser en tournant les paumes vers l\'extérieur','Inverser la rotation en descente'], tips:'Cible les trois chefs du deltoïde.' },
  'Bicep Curl': { name:'Curl biceps', muscles:'Biceps', howTo:['Bras en extension complète','Curl vers les épaules','Contracter au sommet','Redescendre complètement'], tips:'Ne balancez pas le corps.' },
  'Hammer Curl': { name:'Curl marteau', muscles:'Biceps, Avant-bras', howTo:['Prise neutre (pouces vers le haut)','Curl sans rotation du poignet'], tips:'Développe l\'épaisseur du bras.' },
  'Tricep Pushdown': { name:'Extension triceps à la poulie', muscles:'Triceps', howTo:['Coudes fixés sur les côtés','Pousser vers le bas jusqu\'en extension complète','Contracter les triceps'], tips:'Ne laissez pas les coudes s\'écarter.' },
  'Skull Crushers': { name:'Barre au front', muscles:'Triceps', howTo:['Allongé sur banc, barre au-dessus de la poitrine','Descendre vers le front en fléchissant les coudes','Revenir en extension'], tips:'Seuls les avant-bras bougent.' },
  'Plank': { name:'Gainage', muscles:'Core, Épaules, Fessiers', howTo:['Avant-bras au sol','Corps droit de la tête aux talons','Contracter le core et les fessiers'], tips:'La qualité prime sur la durée.' },
  'Crunches': { name:'Crunchs', muscles:'Abdominaux', howTo:['Genoux fléchis, mains derrière la tête','Décoller les épaules en contractant les abdos','Redescendre lentement'], tips:'L\'amplitude courte est intentionnelle.' },
  'Leg Raises': { name:'Relevés de jambes', muscles:'Abdominaux inférieurs', howTo:['Allongé à plat','Lever les jambes à 90°','Redescendre lentement sans toucher le sol'], tips:'Plus lent = plus difficile.' },
  'Russian Twist': { name:'Rotation russe', muscles:'Obliques', howTo:['Pieds décollés, légèrement incliné','Rotation du tronc de côté en côté'], tips:'Contrôlez le mouvement.' },
  'Mountain Climbers': { name:'Grimpeurs', muscles:'Core, Cardio', howTo:['Position pompe','Ramener les genoux vers la poitrine en alternance'], tips:'Rapide = cardio, lent = core.' },
  'Running': { name:'Course à pied', muscles:'Corps entier, Cardiovasculaire', howTo:['Échauffement 5 min','Attérir sur le milieu du pied','Bras à 90°','Respirer de manière rythmique'], tips:'Allure conversationnelle pour la base aérobie.' },
  'Cycling': { name:'Vélo', muscles:'Quadriceps, Ischio-jambiers, Fessiers', howTo:['Régler la selle','Cadence 80-100 RPM','Core engagé'], tips:'Cadence plus élevée ménage les articulations.' },
  'Jump Rope': { name:'Corde à sauter', muscles:'Corps entier, Mollets', howTo:['Tenir les poignées à hauteur des hanches','Rester sur les pointes des pieds','Petits sauts efficaces'], tips:'Brûle ~10 kcal/min.' },
  'Swimming': { name:'Natation', muscles:'Corps entier', howTo:['Échauffement avec des longueurs faciles','Focus sur des mouvements longs et fluides','Respirer tous les 2-3 mouvements'], tips:'Impact articulaire nul.' },
  'HIIT': { name:'HIIT', muscles:'Corps entier', howTo:['Échauffement 5 min','Effort à 90%+ pendant 20-40 sec','Repos 10-20 sec','8-20 séries'], tips:'Le vrai HIIT c\'est un effort maximal.' },
  'Walking': { name:'Marche', muscles:'Jambes, Cardiovasculaire', howTo:['Tête haute, épaules en arrière','Balancer les bras naturellement','Pousser avec les orteils','Viser 5-6 km/h'], tips:'10 000 pas ≈ 400-500 kcal.' },
  'Rowing Machine': { name:'Rameur', muscles:'Corps entier, Dos', howTo:['Les jambes d\'abord','Puis incliner le dos en arrière','Puis tirer les bras','Inverser la séquence'], tips:'Jambes 60%, dos 20%, bras 20%.' },
  'Burpee': { name:'Burpee', muscles:'Corps entier', howTo:['Mains au sol','Sauter les pieds en arrière','Pompe (optionnel)','Sauter les pieds vers les mains','Sauter avec les bras au-dessus'], tips:'Gardez un rythme régulier.' },
  'Kettlebell Swing': { name:'Kettlebell swing', muscles:'Fessiers, Ischio-jambiers, Core', howTo:['Charnière de hanche','Balancer entre les jambes','Pousser les hanches vers l\'avant','Le kettlebell monte à hauteur de la poitrine'], tips:'La puissance vient des hanches.' },
  'Box Jump': { name:'Saut sur box', muscles:'Quadriceps, Fessiers, Puissance', howTo:['Face à la box','Balancer les bras, fléchir les genoux','Exploser vers le haut','Atterrir doucement avec les genoux fléchis'], tips:'Atterrir silencieusement = bonne technique.' },
  'Thruster': { name:'Thruster', muscles:'Corps entier', howTo:['Barre à hauteur des épaules','Squat jusqu\'au parallèle','Exploser vers le haut','Utiliser l\'élan pour presser la barre au-dessus'], tips:'Squat et presse doivent être un seul mouvement.' },
  'Wall Ball': { name:'Wall ball', muscles:'Corps entier', howTo:['Squat avec la balle à la poitrine','Exploser vers le haut','Lancer la balle vers la cible','Attraper et immédiatement squatter'], tips:'Gardez la poitrine haute dans le squat.' },
  'Sun Salutation': { name:'Salutation au soleil', muscles:'Corps entier, Souplesse', howTo:['Debout, mains au cœur','Inspirer, bras au-dessus','Expirer, flexion avant','Planche, descente au sol','Inspirer, chien tête en haut','Expirer, chien tête en bas'], tips:'Bougez avec votre respiration.' },
  'Warrior Pose': { name:'Posture du guerrier', muscles:'Jambes, Hanches, Équilibre', howTo:['Fente avant, genou à 90°','Jambe arrière tendue','Bras levés au-dessus de la tête','Tenir 30-60 sec de chaque côté'], tips:'Focus sur la stabilité et la respiration.' },
  ...
  'Downward Dog': { name:'Chien tête en bas', muscles:'Ischio-jambiers, Mollets, Épaules', howTo:['Mains et pieds au sol','Lever les hanches vers le haut et l\'arrière','Ligne droite des mains aux hanches','Pousser les talons vers le sol'], tips:'Fléchir les genoux si les ischio sont tendus.' },
  'The Hundred': { name:'Les cent', muscles:'Core, Respiration', howTo:['Jambes en tabletop','Lever la tête et les épaules','Pomper les bras 100 fois','Inspirer 5, expirer 5'], tips:'Dos bas collé au tapis.' },
  'Roll Up': { name:'Roll up', muscles:'Abdominaux, Colonne vertébrale', howTo:['Allongé, bras au-dessus de la tête','Décoller vertèbre par vertèbre','Atteindre les orteils','Redescendre avec le même contrôle'], tips:'Articulation vertébrale, pas un abdo.' },
  'Jab-Cross': { name:'Jab-cross', muscles:'Épaules, Core', howTo:['Position de garde boxe','Jab : coup rapide de la main avant','Cross : coup puissant de la main arrière avec rotation des hanches','Revenir en garde'], tips:'La puissance vient de la rotation.' },
  'Shadow Boxing': { name:'Boxe à l\'ombre', muscles:'Corps entier, Cardio', howTo:['Se déplacer en permanence sur les pointes','Enchaîner les coups, jabs, crochets, uppercuts','Ajouter du travail de pieds'], tips:'Séries de 3 min, repos 1 min.' },
  'Heavy Bag': { name:'Sac de frappe', muscles:'Corps entier, Puissance', howTo:['Bander les mains d\'abord','Utiliser la bonne garde','Enchaîner les combinaisons','Garder la garde entre les coups'], tips:'Focus sur la technique, pas que la puissance.' },
  'Hamstring Stretch': { name:'Étirement ischio-jambiers', muscles:'Ischio-jambiers', howTo:['Assis ou allongé','Lever une jambe','Garder le genou aussi droit que possible','Tenir 30-60 sec de chaque côté'], tips:'Ne forcez jamais l\'étirement.' },
  'Hip Flexor Stretch': { name:'Étirement fléchisseurs de hanche', muscles:'Fléchisseurs de hanche', howTo:['Un genou au sol','Avancer les hanches jusqu\'à sentir l\'étirement','Garder le tronc droit'], tips:'Idéal après une longue position assise.' },
  'Pigeon Pose': { name:'Posture du pigeon', muscles:'Hanches, Bande iliotibiale', howTo:['Depuis chien tête en bas','Genou avant derrière le poignet','Étendre la jambe arrière','Tenir 1-2 min de chaque côté'], tips:'Un des meilleurs étirements des hanches.' },
  'Chest Opener': { name:'Ouverture de poitrine', muscles:'Pectoraux, Posture', howTo:['Joindre les mains derrière le dos','Contracter les omoplates','Lever légèrement les bras'], tips:'Faire après tout entraînement de poussée.' },
  'Handstand Hold': { name:'Maintien poirier', muscles:'Épaules, Core, Équilibre', howTo:['Mains écartées à la largeur des épaules','Monter contre un mur d\'abord','Engager le core et les fessiers','Travailler vers l\'équilibre sans mur'], tips:'Maîtriser le mur avant de le faire librement.' },
  'Pistol Squat': { name:'Squat pistol', muscles:'Quadriceps, Équilibre', howTo:['Se tenir sur une jambe','Étendre l\'autre jambe vers l\'avant','Descendre sur une seule jambe','Remonter par le talon'], tips:'Utiliser un cadre de porte pour apprendre.' },
  'L-Sit': { name:'L-sit', muscles:'Core, Triceps', howTo:['Mains à côté des hanches','Pousser vers le bas pour soulever le corps','Étendre les jambes parallèles au sol'], tips:'Extrêmement difficile. Commencer les genoux fléchis.' },
  'Jump Squat': { name:'Squat sauté', muscles:'Quadriceps, Fessiers, Puissance', howTo:['Descendre en squat','Exploser vers le haut en sautant','Atterrir avec les genoux souples'], tips:'Atterrir avec des genoux souples.' },
  'High Knees': { name:'Montées de genoux', muscles:'Core, Cardio', howTo:['Courir sur place','Monter les genoux à hauteur des hanches','Pomper les bras en opposition'], tips:'Plus les genoux sont hauts, plus le core travaille.' },
  'Jumping Jacks': { name:'Jumping jacks', muscles:'Corps entier, Cardio', howTo:['Debout, pieds ensemble','Sauter pieds écartés, bras au-dessus','Revenir en position de départ'], tips:'Classique d\'échauffement.' },
  'Burpee Box Jump': { name:'Burpee saut sur box', muscles:'Corps entier, Puissance', howTo:['Faire un burpee','Au saut, atterrir sur la box','Descendre, recommencer'], tips:'Exercice avancé. Réduire la vitesse pour la sécurité.' },
  'Roundhouse Kick': { name:'Coup de pied circulaire', muscles:'Jambes, Core, Hanches', howTo:['Position de garde','Lever le genou de la jambe qui frappe sur le côté','Pivoter sur le pied d\'appui','Étendre la jambe en arc','Rétracter la jambe'], tips:'La puissance vient de la rotation des hanches.' },
  'Kata Practice': { name:'Pratique de kata', muscles:'Corps entier', howTo:['Position de départ','Effectuer la séquence de manière délibérée','Chaque mouvement est intentionnel'], tips:'Focus sur la précision, pas la vitesse.' },
  'Kettlebell Clean': { name:'Kettlebell clean', muscles:'Corps entier, Puissance', howTo:['Balancer le kettlebell entre les jambes','Pousser les hanches, tirer vers le haut','Attraper en position rack','Coude près du corps'], tips:'Le clean est la base de la plupart des mouvements KB.' },
  'Turkish Get Up': { name:'Turkish get-up', muscles:'Corps entier, Stabilité', howTo:['Allongé, kettlebell verrouillé au-dessus','Se lever lentement par étapes','Inverser le mouvement pour redescendre'], tips:'Aller lentement. C\'est une compétence de force.' },
  'Goblet Squat': { name:'Squat goblet', muscles:'Quadriceps, Fessiers, Core', howTo:['Tenir le kettlebell à la poitrine','Pieds légèrement écartés','Squat profond, coudes à l\'intérieur des genoux','Remonter'], tips:'Excellent pour la profondeur du squat et la posture.' },
  'Battle Ropes': { name:'Cordes ondulatoires', muscles:'Bras, Core, Cardio', howTo:['Tenir une extrémité de chaque côté','Vagues alternatives des bras','Garder le core gainé','Varier les patterns'], tips:'Outil de conditionnement brutal.' },
  'Medicine Ball Slam': { name:'Medicine ball slam', muscles:'Corps entier, Core, Puissance', howTo:['Tenir la balle au-dessus de la tête','Légèrement fléchir les genoux','Claquer la balle au sol fort','Attraper ou ramasser, recommencer'], tips:'Excellent pour la puissance et l\'évacuation de stress.' },
  'Tennis Forehand': { name:'Coup droit tennis', muscles:'Épaule, Core, Poignet', howTo:['De côté par rapport au filet','Balancer la raquette en arrière','Avancer, rotation des hanches et des épaules','Contact devant le corps','Suivre au-dessus de l\'épaule'], tips:'Le suivi détermine l\'effet et le contrôle.' },
  'Badminton Smash': { name:'Smash badminton', muscles:'Épaule, Poignet, Core', howTo:['Positionner derrière le volant','Sauter si nécessaire','Plein élan au-dessus de la tête','Claquer le poignet au contact'], tips:'Le smash le plus puissant du badminton.' },
  'Football Sprint': { name:'Sprint football', muscles:'Vitesse, Jambes', howTo:['Pousser sur le pied arrière, se pencher en avant','Pomper les bras agressivement','Lever les genoux haut'], tips:'90% du football se joue en sprints sous 30m.' },
  'Basketball Dribbling': { name:'Dribble basketball', muscles:'Coordination, Mains', howTo:['Utiliser les doigts, pas la paume','Balle sous la taille','Position athlétique','Pratiquer des deux mains'], tips:'Les bons dribbleurs ne regardent jamais la balle.' },
  'Volleyball Spike': { name:'Smash volleyball', muscles:'Épaule, Saut, Core', howTo:['Approche : 3-4 pas','Sauter des deux pieds','Armer le bras au-dessus de la tête','Claquer le poignet au contact'], tips:'La vitesse du bras crée la puissance.' },
  'Golf Swing': { name:'Swing de golf', muscles:'Core, Épaules, Rotation', howTo:['Adresser la balle, léger fléchissement des genoux','Takeaway : club, bras et épaules ensemble','Enrouler le tronc en backswing','Les hanches mènent en downswing','Impact : poids en avant, suivre'], tips:'La prise doit être comme tenir un petit oiseau.' },
  'Zumba Basic Step': { name:'Pas de base zumba', muscles:'Corps entier, Cardio', howTo:['Pas de côté avec balancement des hanches','Ajouter des mouvements de bras sur le rythme','Laisser la musique guider le rythme'], tips:'Ne pas trop réfléchir — juste bouger et s\'amuser.' },
  'Cartwheel': { name:'Roue', muscles:'Corps entier, Coordination', howTo:['Pied dominant en avant','Planter la main avant, puis la main arrière','Lancer les jambes en arc','Atterrir pieds écartés, bras levés'], tips:'Garder les bras tendus tout au long du mouvement.' },

  'Brisk Walk or Easy Bike': { name:'Marche rapide ou vélo facile', muscles:'Corps entier, Cardio', howTo:['Choisissez l\'un ou l\'autre — marche rapide ou vélo facile','Effort léger, juste assez pour élever le rythme cardiaque'], tips:'C\'est de la préparation, pas la séance — restez facile.' },
  'Easy Rowing or Bike': { name:'Rameur facile ou vélo', muscles:'Corps entier, Cardio', howTo:['Choisissez l\'un ou l\'autre — rameur facile ou vélo facile','Effort léger et régulier pour élever la température corporelle'], tips:'Gardez votre énergie pour les séries de travail.' },
  'Easy Rowing Machine': { name:'Rameur facile', muscles:'Corps entier, Cardio', howTo:['Allure de rameur légère et régulière','Concentrez-vous sur la technique, pas l\'effort'], tips:'Juste assez pour transpirer légèrement.' },
  'Easy Bike': { name:'Vélo facile', muscles:'Corps entier, Cardio', howTo:['Allure de pédalage facile et régulière','Élevez doucement le rythme cardiaque avant de solliciter les jambes'], tips:'Gardez une résistance légère.' },
  'Easy Bike or Row': { name:'Vélo facile ou rameur', muscles:'Corps entier, Cardio', howTo:['Choisissez l\'un ou l\'autre — vélo facile ou rameur facile','Effort léger et régulier uniquement'], tips:'C\'est de la préparation, pas la séance.' },
  'Easy Walk': { name:'Marche facile', muscles:'Corps entier, Retour au calme', howTo:['Allure de marche lente et détendue','Laissez le rythme cardiaque redescendre progressivement'], tips:'Une bonne façon de commencer à faire redescendre le corps.' },
  'Slow Walk': { name:'Marche lente', muscles:'Corps entier, Retour au calme', howTo:['Allure de marche très facile','Respirez normalement, laissez le corps récupérer'], tips:'Aucun effort requis — pure récupération.' },
  'Bodyweight Squat': { name:'Squat au poids du corps', muscles:'Quadriceps, Fessiers', howTo:['Pieds écartés à la largeur des épaules','Asseyez-vous en arrière et vers le bas, poitrine haute','Les genoux suivent la direction des orteils','Remontez avec contrôle'], tips:'Aucun poids nécessaire — il s\'agit de réveiller le mouvement.' },
  'Arm Circles': { name:'Cercles de bras', muscles:'Épaules', howTo:['Étendez les bras sur les côtés','Faites de petits cercles, puis de plus en plus grands','Inversez le sens à mi-parcours'], tips:'Excellent échauffement simple des épaules.' },
  'Hip Hinge Drill': { name:'Exercice de charnière de hanche', muscles:'Ischio-jambiers, Fessiers', howTo:['Debout, genoux légèrement fléchis','Reculez les hanches en gardant le dos plat','Sentez l\'étirement des ischio-jambiers','Poussez les hanches vers l\'avant pour vous redresser'], tips:'C\'est le schéma moteur derrière chaque variante de soulevé de terre.' },
  'Wall Push-Up': { name:'Pompe au mur', muscles:'Pectoraux, Épaules, Triceps', howTo:['Debout face à un mur, mains à hauteur de poitrine','Abaissez la poitrine vers le mur','Repoussez pour revenir au départ'], tips:'Une façon douce d\'activer les muscles poussants avant le développé couché.' },
  'Band Pull-Aparts': { name:'Écartés élastique', muscles:'Deltoïdes postérieurs, Haut du dos', howTo:['Tenez un élastique léger à hauteur de poitrine, bras tendus','Écartez l\'élastique jusqu\'à toucher la poitrine','Contrôlez le retour'], tips:'Excellent pour la santé des épaules et l\'activation posturale.' },
  'Scapular Push-Ups': { name:'Pompes scapulaires', muscles:'Épaules, Haut du dos', howTo:['Position planche ou pompe, bras tendus','Laissez les omoplates se rapprocher puis s\'écarter','Les coudes restent tendus tout du long'], tips:'Petit mouvement — cela active les omoplates, pas les bras.' },
  'Band Straight-Arm Pulldown': { name:'Tirage bras tendus à l\'élastique', muscles:'Dorsaux, Dos', howTo:['Tenez l\'élastique au-dessus de la tête, bras tendus','Tirez l\'élastique vers les cuisses, bras toujours tendus','Contrôlez le retour'], tips:'Excellente activation des dorsaux avant le travail de tirage.' },
  'Scapular Pull-Up or Scapular Pulldown': { name:'Traction scapulaire', muscles:'Dorsaux, Haut du dos', howTo:['Suspendez-vous à la barre (ou tenez une barre de tirage)','Sans plier les coudes, tirez les omoplates vers le bas et l\'une vers l\'autre','Relâchez avec contrôle'], tips:'Cela prépare les dorsaux avant le vrai travail de tirage.' },
  'Light Cable Row': { name:'Rowing léger à la poulie', muscles:'Dos, Biceps', howTo:['Poids très léger au rowing à la poulie','Concentrez-vous uniquement sur la technique et l\'amplitude complète'], tips:'C\'est une série d\'échauffement, pas une série de travail.' },
  'Glute Bridge': { name:'Pont fessier', muscles:'Fessiers, Ischio-jambiers', howTo:['Allongé sur le dos, genoux pliés, pieds à plat','Poussez les hanches vers le haut, contractez les fessiers en haut','Redescendez avec contrôle'], tips:'Réveille les fessiers avant les squats et soulevés de terre.' },
  'Reverse Lunge': { name:'Fente arrière', muscles:'Quadriceps, Fessiers', howTo:['Reculez d\'un pas en fente','Le genou avant reste au-dessus de la cheville','Poussez sur le pied avant pour revenir debout'], tips:'Plus doux pour les genoux qu\'une fente avant — bon pour l\'échauffement.' },
  'Cat-Cow': { name:'Chat-vache', muscles:'Colonne vertébrale, Core', howTo:['À quatre pattes','Cambrez le dos, ventre vers le bas, regard vers le haut (vache)','Arrondissez le dos, menton rentré (chat)','Alternez lentement entre les deux'], tips:'Mobilise en douceur toute la colonne vertébrale.' },
  'Pelvic Tilt': { name:'Bascule du bassin', muscles:'Core, Bas du dos', howTo:['Allongé sur le dos, genoux pliés','Aplatissez le bas du dos au sol en basculant le bassin','Relâchez et répétez'], tips:'Un exercice d\'activation du core subtil mais efficace.' },
  'Bird Dog Practice': { name:'Pratique bird dog', muscles:'Core, Équilibre', howTo:['À quatre pattes','Étendez un bras et la jambe opposée','Gardez les hanches de niveau, tenez brièvement','Revenez et changez de côté'], tips:'Pratiquez lentement ici — cela prépare le mouvement pour la série principale.' },
  'Barbell Bench Press': { name:'Développé couché à la barre', muscles:'Pectoraux, Triceps, Épaules', howTo:['Allongé, pieds au sol','Prise légèrement plus large que les épaules','Descendez au milieu de la poitrine avec contrôle','Poussez vers le haut de manière explosive'], tips:'Ne rebondissez jamais la barre sur la poitrine.' },
  'Dumbbell Bench Press': { name:'Développé couché haltères', muscles:'Pectoraux, Triceps, Épaules', howTo:['Allongé sur un banc, haltères à hauteur de poitrine','Poussez vers le haut jusqu\'à extension complète','Redescendez avec contrôle vers la poitrine'], tips:'Les haltères permettent un étirement légèrement plus profond qu\'une barre.' },
  'Incline Dumbbell Press': { name:'Développé incliné haltères', muscles:'Haut des pectoraux, Épaules', howTo:['Réglez le banc à 30-45 degrés','Poussez les haltères au-dessus du haut de la poitrine','Redescendez avec contrôle'], tips:'Cible davantage le haut des pectoraux qu\'un développé plat.' },
  'Cable Chest Fly': { name:'Écarté poulie basse', muscles:'Pectoraux', howTo:['Réglez les poulies à hauteur de poitrine, avancez d\'un pas','Rapprochez les poignées devant la poitrine, coude légèrement fléchi','Contrôlez le retour jusqu\'à l\'étirement complet'], tips:'Contractez la poitrine au point où les mains se rejoignent.' },
  'Seated Dumbbell Shoulder Press': { name:'Développé épaules assis haltères', muscles:'Épaules, Triceps', howTo:['Assis, dos soutenu, haltères à hauteur d\'épaules','Poussez au-dessus de la tête jusqu\'à extension complète','Redescendez avec contrôle vers les épaules'], tips:'Gardez le core gainé pour protéger le bas du dos.' },
  'Dumbbell Lateral Raise': { name:'Élévations latérales haltères', muscles:'Deltoïdes latéraux', howTo:['Tenez les haltères le long du corps','Levez les bras sur les côtés jusqu\'à hauteur d\'épaules','Redescendez avec contrôle'], tips:'Un poids plus léger avec une forme stricte vaut mieux qu\'un poids lourd avec élan.' },
  'Triceps Rope Pushdown': { name:'Extension triceps à la corde', muscles:'Triceps', howTo:['Debout à la poulie avec une corde','Coudes fixes le long du corps','Poussez vers le bas jusqu\'à extension complète, écartez la corde en bas'], tips:'Gardez les coudes fixes — seuls les avant-bras doivent bouger.' },
  'Lat Pulldown or Assisted Pull-Up': { name:'Tirage vertical ou traction assistée', muscles:'Dorsaux, Biceps', howTo:['Utilisez la machine de tirage vertical ou de tractions assistées','Tirez la barre vers le haut de la poitrine (ou hissez le corps)','Contrôlez le retour jusqu\'à l\'étirement complet'], tips:'Choisissez l\'option qui vous permet de faire toutes les répétitions avec une bonne forme.' },
  'Chest-Supported Dumbbell Row': { name:'Rowing buste appuyé haltères', muscles:'Dos, Biceps', howTo:['Allongé face contre un banc incliné, haltères en main','Tirez les haltères vers les hanches','Contractez les omoplates, puis redescendez avec contrôle'], tips:'Le support de poitrine élimine l\'élan et isole les muscles du dos.' },
  'Dumbbell Curl': { name:'Curl haltères', muscles:'Biceps', howTo:['Debout, haltères en main, bras tendus','Fléchissez les haltères vers les épaules','Redescendez avec contrôle'], tips:'Ne balancez pas le corps pour aider le poids à monter.' },
  'Back Squat': { name:'Squat arrière', muscles:'Quadriceps, Fessiers, Ischio-jambiers', howTo:['Barre sur le haut du dos, pieds à largeur d\'épaules','Gainez le core, asseyez-vous en arrière et vers le bas','Descendez jusqu\'à ce que les cuisses soient au moins parallèles','Poussez dans le sol pour vous relever'], tips:'Les genoux doivent suivre la direction des orteils tout du long.' },
  'Dumbbell Romanian Deadlift': { name:'Soulevé de terre roumain haltères', muscles:'Ischio-jambiers, Fessiers', howTo:['Tenez les haltères devant les cuisses','Reculez les hanches, abaissez les poids le long des jambes','Sentez l\'étirement des ischio-jambiers, puis poussez les hanches vers l\'avant'], tips:'C\'est une charnière de hanche, pas un squat — gardez les poids près des jambes.' },
  'Walking Lunge': { name:'Fente marchée', muscles:'Quadriceps, Fessiers', howTo:['Avancez d\'un pas en fente','Poussez sur le pied avant pour amener la jambe arrière dans la fente suivante','Continuez à alterner les jambes en avançant'], tips:'Gardez le torse droit tout du long.' },
  'Seated or Lying Leg Curl': { name:'Leg curl assis ou allongé', muscles:'Ischio-jambiers', howTo:['Utilisez la machine de leg curl assis ou allongé','Fléchissez le coussin vers les fessiers','Contrôlez le retour jusqu\'à extension complète'], tips:'Évitez l\'élan — contrôlez la montée et la descente.' },
  'Standing Calf Raise': { name:'Mollets debout', muscles:'Mollets', howTo:['Debout sur le bord d\'une marche ou d\'une plateforme','Montez sur la pointe des pieds le plus haut possible','Descendez les talons sous la marche pour un étirement complet'], tips:'L\'amplitude complète compte plus que le poids utilisé.' },
  'Front Plank': { name:'Gainage ventral', muscles:'Core, Épaules', howTo:['Avant-bras au sol, coudes sous les épaules','Corps aligné de la tête aux talons','Contractez le core et les fessiers tout du long'], tips:'Arrêtez la série dès qu\'un bon alignement ne peut plus être maintenu.' },
  'Side Plank from Knees or Feet': { name:'Gainage latéral (genoux ou pieds)', muscles:'Obliques, Core', howTo:['Allongé sur le côté, appuyé sur un avant-bras','Levez les hanches pour former une ligne droite','Appui sur les genoux pour une version plus facile, ou les pieds pour plus difficile'], tips:'Choisissez la variante qui vous permet de tenir avec une bonne forme.' },
  'Pallof Press': { name:'Pallof press', muscles:'Core, Obliques', howTo:['Tenez un élastique ou une poulie à hauteur de poitrine, ancré sur le côté','Poussez la poignée droit devant vous','Résistez à la rotation du torse, puis revenez'], tips:'L\'objectif est de résister à la rotation — le torse doit rester face à l\'avant.' },
  'Suitcase Carry': { name:'Suitcase carry', muscles:'Core, Préhension, Obliques', howTo:['Tenez un poids d\'une main le long du corps, comme une valise','Marchez droit, en résistant à la traction d\'un côté','Gardez les épaules de niveau tout du long'], tips:'Résister à l\'inclinaison latérale est tout l\'intérêt de cet exercice.' },
  'Bird Dog': { name:'Bird dog', muscles:'Core, Équilibre', howTo:['À quatre pattes','Étendez complètement un bras et la jambe opposée','Gardez les hanches de niveau, tenez brièvement','Revenez avec contrôle et changez de côté'], tips:'Bougez lentement — il s\'agit de contrôle, pas de vitesse.' },
  'Standing Quadriceps Stretch': { name:'Étirement quadriceps debout', muscles:'Quadriceps', howTo:['Debout sur une jambe, tenez-vous si besoin pour l\'équilibre','Tirez le talon opposé vers les fessiers','Gardez les genoux proches l\'un de l\'autre'], tips:'Tenez fermement, évitez de trop tirer le pied.' },
  'Doorway Chest Stretch': { name:'Étirement poitrine dans l\'embrasure', muscles:'Pectoraux, Épaules', howTo:['Placez l\'avant-bras sur un chambranle de porte, coude à 90 degrés','Penchez-vous doucement en avant à travers la porte','Sentez l\'étirement à travers la poitrine'], tips:'Excellent après tout travail de poussée.' },
  'Seated Hamstring Stretch': { name:'Étirement ischio-jambiers assis', muscles:'Ischio-jambiers', howTo:['Assis avec une jambe tendue, l\'autre pliée','Penchez-vous en avant depuis les hanches au-dessus de la jambe tendue','Gardez le dos aussi plat que possible'], tips:'Ne forcez jamais l\'étirement — installez-vous progressivement.' },
  'Slow Diaphragmatic Breathing': { name:'Respiration diaphragmatique lente', muscles:'Récupération, Respiration', howTo:['Allongé ou assis confortablement','Inspirez lentement par le nez, en gonflant le ventre','Expirez lentement par la bouche'], tips:'Aide à faire passer le corps du mode entraînement au mode récupération.' },
  'Diaphragmatic Breathing': { name:'Respiration diaphragmatique', muscles:'Récupération, Respiration', howTo:['Allongé confortablement sur le dos','Inspirez lentement par le nez, le ventre se soulève','Expirez lentement et complètement par la bouche'], tips:'Une respiration lente signale au système nerveux de se détendre.' },
  'Slow Breathing': { name:'Respiration lente', muscles:'Récupération, Respiration', howTo:['Assis ou debout confortablement','Inspirez lentement par le nez','Expirez lentement par la bouche'], tips:'Une façon simple de terminer la séance calmement.' },
  'Cross-Body Shoulder Stretch': { name:'Étirement épaule croisée', muscles:'Épaules', howTo:['Amenez un bras devant la poitrine','Utilisez l\'autre bras pour le rapprocher doucement','Gardez l\'épaule détendue, loin de l\'oreille'], tips:'Excellent après les mouvements de poussée.' },
  'Cross-Body Rear Shoulder Stretch': { name:'Étirement arrière épaule croisée', muscles:'Deltoïdes postérieurs, Épaules', howTo:['Amenez un bras devant la poitrine à hauteur d\'épaule','Utilisez l\'autre bras pour le presser doucement plus près','Concentrez-vous sur l\'arrière de l\'épaule'], tips:'Cible les deltoïdes postérieurs sollicités pendant les exercices de tirage.' },
  'Overhead Triceps Stretch': { name:'Étirement triceps au-dessus de la tête', muscles:'Triceps', howTo:['Levez un bras au-dessus de la tête, pliez le coude pour laisser tomber la main derrière la tête','Utilisez l\'autre main pour presser doucement le coude vers l\'arrière','Gardez le torse droit'], tips:'Bougez doucement — les triceps peuvent être raides après le travail de poussée.' },
  'Lat Stretch': { name:'Étirement dorsaux', muscles:'Dorsaux, Dos', howTo:['Tenez-vous à une barre ou un chambranle de porte','Reculez et abaissez les hanches, en laissant les dorsaux s\'étirer','Gardez les bras tendus'], tips:'Un bon relâchement après le travail de tirage.' },
  'Forearm Flexor Stretch': { name:'Étirement fléchisseurs avant-bras', muscles:'Avant-bras', howTo:['Tendez un bras devant vous, paume vers le haut','Utilisez l\'autre main pour tirer doucement les doigts vers l\'arrière','Sentez l\'étirement dans l\'avant-bras'], tips:'Aide après les curls et le travail de tirage intense en préhension.' },
  'Half-Kneeling Hip Flexor Stretch': { name:'Étirement fléchisseurs de hanche à genoux', muscles:'Fléchisseurs de hanche', howTo:['Un genou au sol, l\'autre pied devant, à plat au sol','Avancez le poids jusqu\'à sentir un étirement à l\'avant de la hanche','Gardez le torse droit'], tips:'Excellent après les squats et les fentes.' },
  'Calf Stretch': { name:'Étirement mollets', muscles:'Mollets', howTo:['Debout face à un mur, un pied en arrière, talon à plat au sol','Penchez-vous doucement en avant jusqu\'à sentir l\'étirement dans le mollet','Gardez la jambe arrière tendue'], tips:'Tenez fermement, évitez de rebondir.' },
  'Supine Knee-to-Chest Stretch': { name:'Étirement genou-poitrine allongé', muscles:'Bas du dos, Fessiers', howTo:['Allongé sur le dos','Tirez doucement un genou vers la poitrine','Gardez l\'autre jambe détendue au sol'], tips:'Un relâchement doux pour le bas du dos.' },
  'Gentle Supine Trunk Rotation': { name:'Rotation du tronc allongé', muscles:'Colonne vertébrale, Obliques', howTo:['Allongé sur le dos, genoux pliés','Laissez les deux genoux tomber doucement d\'un côté','Gardez les épaules à plat au sol'], tips:'Bougez lentement — c\'est un relâchement doux de la colonne, pas une torsion profonde.' },}
...
export function getExercise(name, lang) {
  ...
  if (lang === 'fr' && EXERCISES_FR[name]) {
    // EXERCISES_FR[name].name is the localized display name; the original
    // English `name` stays available separately for icon lookups etc.
    return { ...base, ...EXERCISES_FR[name], name: EXERCISES_FR[name].name || name }
  }
  return { name, ...base }
}

// Centralized helper — the display name for an exercise in the given
// language, with graceful fallback to the original English name if no
// translation exists yet. Never returns undefined.
export function getLocalizedExerciseName(name, lang) {
  if (!name) return ''
  if (lang === 'fr' && EXERCISES_FR[name]?.name) return EXERCISES_FR[name].name
  return name
}

// ─────────────────────────────────────────────────────────────
// Workout-level localization — descriptions and per-exercise coaching
// notes. Currently fully translated for Weight Training; other sports
// fall back to English until translated (see getLocalizedText below).
// ─────────────────────────────────────────────────────────────
export const WORKOUT_DESC_FR = {
  full_body: 'Apprenez les schémas moteurs fondamentaux et construisez une base de force équilibrée pour tout le corps.',
  upper_body: 'Développez une force équilibrée du haut du corps, en poussée comme en tirage.',
  lower_body_foundation: 'Apprenez les schémas moteurs de base du bas du corps — squat, charnière et fente — tout en gagnant en confiance et en technique.',
  core_blast: 'Améliorez le contrôle du tronc, l\'anti-extension, l\'anti-rotation et la stabilité latérale.',
  push_day: 'Développez la force et la musculature de la poitrine, des épaules et des triceps.',
  pull_day: 'Développez le dos, l\'arrière des épaules et les biceps grâce à un tirage vertical et horizontal équilibré.',
  leg_day: 'Travaillez les quadriceps, ischio-jambiers, fessiers et mollets à travers des schémas moteurs complémentaires du bas du corps.',
  adv_full_body_strength: 'Développez une force maximale grâce aux grands mouvements polyarticulaires. Une séance exigeante — récupérez bien avant de la refaire.',
  adv_upper_body_strength: 'Une séance de force exigeante pour le haut du corps, destinée aux pratiquants expérimentés — mouvements composés lourds d\'abord, travail d\'isolation ciblé ensuite.',
}

export const EXERCISE_NOTE_FR = {
  '10 each direction.': '10 dans chaque sens.',
  '10 forward + 10 backward.': '10 vers l\'avant + 10 vers l\'arrière.',
  '10 forward + 10 backward. Rest 30s before starting the main workout.': '10 vers l\'avant + 10 vers l\'arrière. Repos de 30s avant de commencer la séance principale.',
  '3 minutes, easy effort.': '3 minutes, effort facile.',
  '5 controlled breaths.': '5 respirations contrôlées.',
  '6 slow breaths.': '6 respirations lentes.',
  '8 controlled reps.': '8 répétitions contrôlées.',
  '8 easy, controlled reps.': '8 répétitions faciles et contrôlées.',
  'By distance or time — tall posture, don\'t let the shoulders round.': 'Par distance ou par temps — posture droite, ne laissez pas les épaules s\'arrondir.',
  'Choose manageable resistance — focus on learning the movement patterns rather than reaching muscular failure.': 'Choisissez une résistance gérable — concentrez-vous sur l\'apprentissage des mouvements plutôt que sur l\'échec musculaire.',
  'Front knee stays over the ankle. Rest 60s after both legs.': 'Le genou avant reste au-dessus de la cheville. Repos de 60s après les deux jambes.',
  'Full range of motion — pause briefly at the top of each rep.': 'Amplitude complète — marquez une brève pause en haut de chaque répétition.',
  'Hinge at the hips, weights stay close to the legs — feel the stretch in the hamstrings, not the lower back.': 'Charnière au niveau des hanches, les poids restent près des jambes — ressentez l\'étirement dans les ischio-jambiers, pas dans le bas du dos.',
  'Keep accessory work controlled — this is about quality volume, not grinding to failure.': 'Gardez le travail d\'isolation contrôlé — il s\'agit de volume de qualité, pas de forcer jusqu\'à l\'échec.',
  'Lead with controlled shoulder-blade movement — avoid body momentum on rows and curls.': 'Initiez le mouvement avec un contrôle des omoplates — évitez l\'élan du corps sur les rowings et les curls.',
  'Legs are already loaded from squatting — this is a lighter top set, not a max effort pull. Keep it crisp.': 'Les jambes sont déjà sollicitées par le squat — c\'est une série plus légère, pas un tirage maximal. Restez précis.',
  'Prioritise controlled range of motion — use loads that allow the prescribed reps without technical breakdown.': 'Priorisez une amplitude de mouvement contrôlée — utilisez des charges permettant les répétitions prescrites sans dégradation technique.',
  'Progressive light warm-up sets before your first working set below — these do not count as working sets.': 'Séries d\'échauffement progressives et légères avant votre première série de travail ci-dessous — celles-ci ne comptent pas comme séries de travail.',
  'Rest 30s before starting the main workout.': 'Repos de 30s avant de commencer la séance principale.',
  'Rest 45s after both sides.': 'Repos de 45s après les deux côtés.',
  'Rest 45s before starting the main workout.': 'Repos de 45s avant de commencer la séance principale.',
  'Rest 60s after both sides.': 'Repos de 60s après les deux côtés.',
  'Rest 60s after both sides. Prioritise breathing, control and trunk position — stop a set once good alignment can no longer be held.': 'Repos de 60s après les deux côtés. Priorisez la respiration, le contrôle et la position du tronc — arrêtez la série dès qu\'un bon alignement ne peut plus être maintenu.',
  'Rest 90s after both legs are completed.': 'Repos de 90s une fois les deux jambes terminées.',
  'Sit back and down, chest up — this is the pattern every lower-body lift builds on.': 'Asseyez-vous en arrière et vers le bas, poitrine haute — c\'est le schéma sur lequel repose chaque mouvement du bas du corps.',
  'Use controlled reps and keep ~1–2 in reserve on most sets.': 'Utilisez des répétitions contrôlées et gardez environ 1 à 2 répétitions en réserve sur la plupart des séries.',
  'Use light-to-moderate resistance throughout. Finish each set with ~2–3 good reps still possible.': 'Utilisez une résistance légère à modérée tout du long. Terminez chaque série en ayant encore 2 à 3 bonnes répétitions possibles.',
}

// Generic localized-value helper — works with either a plain string
// (untranslated / already resolved) or a {en, fr, ar}-style object,
...
export function getLocalizedWorkoutDescription(workout, lang) {
  if (!workout) return ''
  if (lang === 'fr' && WORKOUT_DESC_FR[workout.id]) return WORKOUT_DESC_FR[workout.id]
  return workout.description || ''
}

export function getLocalizedExerciseNote(note, lang) {
  if (!note) return ''
  if (lang === 'fr' && EXERCISE_NOTE_FR[note]) return EXERCISE_NOTE_FR[note]
  return note
}
