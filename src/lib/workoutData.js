...
export const EXERCISES = {
  ...
  // ── Clear beginner-friendly warm-up options ─────────────────
  'Light Stationary Bike': { icon:'🚴', muscles:'Legs, Cardiovascular System', timed:true, category:'Warm-up',
    howTo:[
      'Sit on a stationary exercise bike',
      'Adjust the seat so your knee stays slightly bent at the bottom of the pedal stroke',
      'Pedal at a comfortable, steady pace',
      'Use light resistance so your legs move easily without straining',
      'You should feel warmer and breathe a little faster, but still be able to speak normally'
    ],
    tips:'This is only a warm-up. Do not tire yourself before the main workout.' },
  'Light Rowing Machine': { icon:'🚣', muscles:'Legs, Back, Arms, Cardiovascular System', timed:true, category:'Warm-up',
    howTo:[
      'Sit on the rowing machine and secure your feet in the straps',
      'Start each stroke by pushing with your legs',
      'As your legs straighten, lean back slightly',
      'Pull the handle toward the lower ribs',
      'Return in reverse order: arms, torso, then knees',
      'Move slowly and smoothly at an easy effort'
    ],
    tips:'The goal is to warm up the body, not to row hard or become tired.' },
  'Light Treadmill Walk': { icon:'🚶', muscles:'Legs, Cardiovascular System', timed:true, category:'Warm-up',
    howTo:[
      'Walk on a treadmill or safe flat space at an easy pace',
      'Stand tall with relaxed shoulders',
      'Let your arms swing naturally',
      'Walk fast enough to feel warm but not tired',
      'You should still be able to speak normally'
    ],
    tips:'Keep the pace easy. This prepares the body for training.' },
  'Dead Bug': { icon:'🧘', muscles:'Core, Deep Abdominals', category:'Core',
    howTo:[
      'Lie on your back with arms pointing toward the ceiling',
      'Lift the legs so hips and knees are bent to about 90 degrees',
      'Gently brace your core and keep the lower back controlled',
      'Slowly lower one arm and the opposite leg toward the floor',
      'Return to the starting position with control',
      'Repeat on the opposite side'
    ],
    tips:'Move slowly and only lower as far as you can while keeping your trunk controlled.' },
...
export const LIBRARY_WORKOUTS = [
  // ── GYM (WEIGHT TRAINING) ─────────────────
  { id:'full_body', sport:'gym', name:'Beginner Full Body', icon:'🏋️', level:'Beginner', duration:'40–45 min', muscles:'All muscle groups',
    description:'A simple beginner-friendly full-body workout using fundamental movement patterns without overwhelming volume.',
    suggestedRestSec:90,
    exercises:[
      rx('Light Stationary Bike', 1, 300, { section:'warmup', restSec:0, note:'5 minutes at an easy pace.' }),
      rx('Bodyweight Squat', 1, 10, { section:'warmup', restSec:30 }),
      rx('Arm Circles', 1, 10, { section:'warmup', restSec:30, note:'10 forward + 10 backward.' }),

      rx('Goblet Squat', 3, 8, { section:'main', restSec:90, repRange:'8–10' }),
      rx('Dumbbell Bench Press', 3, 8, { section:'main', restSec:90, repRange:'8–10' }),
      rx('Seated Cable Row', 3, 10, { section:'main', restSec:75, repRange:'10–12' }),
      rx('Dumbbell Romanian Deadlift', 2, 10, { section:'main', restSec:90 }),
      rx('Front Plank', 2, 20, { section:'main', restSec:45, repRange:'20–30s', note:'Stop when you can no longer hold good alignment.' }),

      rx('Slow Walk', 1, 180, { section:'cooldown', restSec:0 }),
      rx('Slow Diaphragmatic Breathing', 1, 60, { section:'cooldown', restSec:0, note:'6 slow breaths.' }),
    ] },

  { id:'push_day', sport:'gym', name:'Push Day', icon:'💪', level:'Intermediate', duration:'50–60 min', muscles:'Chest · Shoulders · Triceps',
    description:'A focused upper-body pushing session for chest, shoulders and triceps with clear working sets and sensible recovery.',
    suggestedRestSec:90,
    exercises:[
      rx('Light Treadmill Walk', 1, 180, { section:'warmup', restSec:0, note:'3 minutes, easy pace.' }),
      rx('Band Pull-Aparts', 2, 12, { section:'warmup', restSec:30 }),
      rx('Scapular Push-Ups', 2, 8, { section:'warmup', restSec:30 }),

      rx('Barbell Bench Press', 4, 7, { section:'main', restSec:120, repRange:'6–8', note:'Before working sets, perform 2–3 light preparation sets. Do not count them as working sets.' }),
      ...
      rx('Cable Chest Fly', 2, 13, { section:'main', restSec:60, repRange:'12–15' }),
      rx('Dumbbell Lateral Raise', 2, 13, { section:'main', restSec:60, repRange:'12–15' }),
      rx('Triceps Rope Pushdown', 2, 11, { section:'main', restSec:60, repRange:'10–12', note:'Keep 1–2 good reps in reserve on most sets.' }),
  ...
  { id:'pull_day', sport:'gym', name:'Pull Day', icon:'🦾', level:'Intermediate', duration:'50–60 min', muscles:'Back · Biceps · Rear Delts',
    description:'A balanced pulling session using vertical pulls, horizontal rows, rear-shoulder work and biceps training.',
    suggestedRestSec:90,
    exercises:[
      rx('Light Rowing Machine', 1, 240, { section:'warmup', restSec:0, note:'4 minutes at an easy effort.' }),
      rx('Band Pull-Aparts', 2, 12, { section:'warmup', restSec:30 }),
      rx('Band Straight-Arm Pulldown', 2, 10, { section:'warmup', restSec:30 }),

      rx('Lat Pulldown', 4, 9, { section:'main', restSec:90, repRange:'8–10' }),
      ...
      rx('Dumbbell Curl', 2, 11, { section:'main', restSec:60, repRange:'10–12' }),
      rx('Hammer Curl', 2, 12, { section:'main', restSec:60, note:'Avoid body momentum. Control the lowering phase.' }),
  ...
  { id:'leg_day', sport:'gym', name:'Leg Day', icon:'🦵', level:'Intermediate', duration:'55–65 min', muscles:'Quads · Hamstrings · Glutes · Calves',
    description:'A complete lower-body strength session built around squat, hinge, single-leg, hamstring and calf work.',
    suggestedRestSec:120,
    exercises:[
      rx('Light Stationary Bike', 1, 300, { section:'warmup', restSec:0, note:'5 minutes at an easy pace.' }),
      rx('Bodyweight Squat', 1, 10, { section:'warmup', restSec:30 }),
      rx('Glute Bridge', 1, 10, { section:'warmup', restSec:30 }),
      rx('Hip Hinge Drill', 1, 10, { section:'warmup', restSec:30 }),

      rx('Back Squat', 4, 7, { section:'main', restSec:150, repRange:'6–8', note:'Before working sets, perform 2–4 progressively heavier preparation sets. Do not count them as working sets.' }),
      rx('Romanian Deadlift', 3, 9, { section:'main', restSec:120, repRange:'8–10' }),
      rx('Leg Press', 3, 11, { section:'main', restSec:90, repRange:'10–12' }),
      rx('Walking Lunge', 2, 10, { section:'main', restSec:90, unilateral:true, unilateralLabel:'each leg', note:'Rest after both legs are completed.' }),
      rx('Seated Leg Curl', 3, 11, { section:'main', restSec:60, repRange:'10–12' }),
      rx('Standing Calf Raise', 3, 13, { section:'main', restSec:60, repRange:'12–15' }),
  ...
  { id:'upper_body', sport:'gym', name:'Upper Body Foundation', icon:'🏋️', level:'Beginner', duration:'35–45 min', muscles:'Chest · Back · Shoulders · Arms',
    description:'A beginner-friendly upper-body session with balanced pushing and pulling and no unnecessary exercise overload.',
    suggestedRestSec:75,
    exercises:[
      rx('Light Stationary Bike', 1, 180, { section:'warmup', restSec:0, note:'3 minutes at an easy pace.' }),
      rx('Arm Circles', 1, 10, { section:'warmup', restSec:30, note:'10 forward + 10 backward.' }),
      rx('Band Pull-Aparts', 1, 12, { section:'warmup', restSec:30 }),

      rx('Dumbbell Bench Press', 3, 8, { section:'main', restSec:90, repRange:'8–10' }),
      rx('Lat Pulldown', 3, 10, { section:'main', restSec:90 }),
      rx('Seated Dumbbell Shoulder Press', 2, 10, { section:'main', restSec:75 }),
      rx('Seated Cable Row', 2, 12, { section:'main', restSec:75 }),
      rx('Triceps Rope Pushdown', 2, 12, { section:'main', restSec:60 }),
      rx('Dumbbell Curl', 2, 12, { section:'main', restSec:60, note:'Use manageable resistance and controlled reps.' }),

      rx('Doorway Chest Stretch', 1, 30, { section:'cooldown', restSec:0, unilateral:true, unilateralLabel:'each side' }),
      rx('Lat Stretch', 1, 30, { section:'cooldown', restSec:0, unilateral:true, unilateralLabel:'each side' }),
      rx('Slow Breathing', 1, 45, { section:'cooldown', restSec:0 }),
    ] },

  { id:'core_blast', sport:'gym', name:'Core Stability', icon:'🧘', level:'Beginner', duration:'20–25 min', muscles:'Core · Abs · Obliques',
    description:'A controlled beginner core session focused on trunk control, breathing and stability rather than random ab volume.',
    suggestedRestSec:45,
    exercises:[
      ...
      rx('Front Plank', 2, 20, { section:'main', restSec:45, repRange:'20–30s' }),
      rx('Bird Dog', 2, 8, { section:'main', restSec:45, unilateral:true, unilateralLabel:'each side' }),
      rx('Side Plank from Knees or Feet', 2, 20, { section:'main', restSec:45, repRange:'20–30s', unilateral:true, unilateralLabel:'each side', note:'Rest after both sides.' }),
      rx('Pallof Press', 2, 10, { section:'main', restSec:60, unilateral:true, unilateralLabel:'each side', note:'Rest after both sides.' }),
      ...
      rx('Diaphragmatic Breathing', 1, 60, { section:'cooldown', restSec:0, note:'6 slow breaths.' }),
    ] },
...
export const EXERCISES_FR = {
  'Light Stationary Bike': { muscles:'Jambes, Système cardiovasculaire', howTo:['Asseyez-vous sur un vélo d’appartement','Réglez la selle pour garder le genou légèrement fléchi en bas du pédalage','Pédalez à une allure confortable et régulière','Utilisez une résistance légère, sans forcer','Vous devez vous échauffer sans vous fatiguer'], tips:'C’est seulement un échauffement. Gardez de l’énergie pour la séance principale.' },
  'Light Rowing Machine': { muscles:'Jambes, Dos, Bras, Système cardiovasculaire', howTo:['Asseyez-vous sur le rameur et attachez les pieds','Commencez chaque tirage en poussant avec les jambes','Quand les jambes s’étendent, inclinez légèrement le buste en arrière','Tirez la poignée vers le bas des côtes','Revenez dans l’ordre inverse : bras, buste, puis genoux','Bougez lentement et facilement'], tips:'Le but est de s’échauffer, pas de ramer fort.' },
  'Light Treadmill Walk': { muscles:'Jambes, Système cardiovasculaire', howTo:['Marchez sur un tapis ou dans un espace plat et sûr','Gardez une posture droite et les épaules détendues','Laissez les bras bouger naturellement','Marchez assez vite pour vous échauffer, sans vous fatiguer','Vous devez pouvoir parler normalement'], tips:'Gardez une allure facile. Cela prépare le corps à l’entraînement.' },
  'Dead Bug': { muscles:'Core, Abdominaux profonds', howTo:['Allongez-vous sur le dos, bras vers le plafond','Levez les jambes avec les hanches et les genoux à environ 90 degrés','Contractez doucement le core et contrôlez le bas du dos','Descendez lentement un bras et la jambe opposée vers le sol','Revenez avec contrôle','Alternez de l’autre côté'], tips:'Bougez lentement et descendez seulement aussi loin que vous pouvez garder le tronc contrôlé.' },
